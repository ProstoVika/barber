...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\n__webpack_require__(/*! ./team.css */ \"./src/pages/team/team.css\");\nvar MinimalGallery = /** @class */ (function () {\n    function MinimalGallery() {\n        // Ініціалізація елементів\n        this.modal = document.getElementById('modal');\n        this.modalImage = document.getElementById('modalImage');\n        this.closeButton = this.modal.querySelector('.close');\n        this.init();\n    }\n    MinimalGallery.prototype.init = function () {\n        var _this = this;\n        // Додаємо обробник кліків до кожного зображення\n        document.querySelectorAll('.gallery img').forEach(function (img) {\n            img.addEventListener('click', function (event) {\n                _this.openModal(event.target.src);\n            });\n        });\n        // Додаємо обробник для кнопки закриття\n        this.closeButton.addEventListener('click', function () { return _this.closeModal(); });\n    };\n    MinimalGallery.prototype.openModal = function (imageSrc) {\n        this.modal.style.display = 'flex';\n        this.modalImage.src = imageSrc;\n    };\n    MinimalGallery.prototype.closeModal = function () {\n        this.modal.style.display = 'none';\n    };\n    return MinimalGallery;\n}());\n// Ініціалізація класу після завантаження DOM\ndocument.addEventListener('DOMContentLoaded', function () {\n    new MinimalGallery();\n});\n\n\n//# sourceURL=webpack://task-2.7/./src/pages/team/team.ts?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/pages/team/team.ts");
/******/ 	
/******/ })()
;